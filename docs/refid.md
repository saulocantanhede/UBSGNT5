...
## Description
reference to the structure of a range of words in the dataset (e.g., phrase, subphrase) of the textual participant a word is referring to (excluding subject)
## Feature Values
