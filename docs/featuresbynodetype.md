...
Feature|Feature type|Data type|Description|Examples
---|---|---|---|---
[`nodeid`](nodeid.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`400010010010081` `400010020010181` `400010030020211` `400010040020151`
[`parent`](parent.md#readme)|[`Edge`](featuresbytype.md#Edge)|[`String`](featuresbydatatype.md#String)|No feature description|`Link`
## tree
...
Feature|Feature type|Data type|Description|Examples
---|---|---|---|---
[`adjectivetype`](adjectivetype.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`NA` `Interrogative` `Common` `Proper`
[`adjuncttype`](adjuncttype.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`` `Relation` `Source` `Goal`
[`adverbtype`](adverbtype.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`NA` `Negative` `Emphatic` `Place`
...
[`label`](label.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`` `OC` `COMP` `IO`
...
[`monad_num`](monad_num.md#readme)|[`Node`](featuresbytype.md#Node)|[`Integer`](featuresbydatatype.md#Integer)|numerical word order|`1` `2` `3` `4`
...
[`nountype`](nountype.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`NA` `Common` `Proper` `Place`
...
[`parent`](parent.md#readme)|[`Edge`](featuresbytype.md#Edge)|[`String`](featuresbydatatype.md#String)|No feature description|`Link`
[`particletype`](particletype.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`NA` `Conditional` `Negative` `Emphatic`
[`person`](person.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|grammatical person|`p3` `p2` `p1`
[`prepositiontype`](prepositiontype.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`` `Located inside` `Directed into` `Directed out of`
[`pronountype`](pronountype.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`NA` `Personal` `Demonstrative` `Relative`
...
[`referent`](referent.md#readme)|[`Edge`](featuresbytype.md#Edge)|[`String`](featuresbydatatype.md#String)|referent|`Link`
[`referent_index`](referent_index.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|index number of referent|`1` `2` `3` `4`
[`referent_lemma`](referent_lemma.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|lexical lemma of referent|`Ἰησοῦς` `ἀδελφός` `Παῦλος` `μαθητής`
[`referent_strong`](referent_strong.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|Strong's number of referent|`2424` `80` `3972` `3101`
[`referent_translation_english`](referent_translation_english.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|English translation of referent|`Jesus` `brothers` `Paul` `disciples`
[`referentspec`](referentspec.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|number of referent|`40005001015` `46003022002` `43014023002` `45001001001`
[`refid`](refid.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`04000100100002` `04000100100004` `04000100100006` `04000100100008`
[`rule`](rule.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`ClCl` `Conj-CL` `V2CL` `CLaCL`
[`section`](section.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|title of textual section|`Stephen’s Speech` `The Crucifixion of Jesus` `Jesus Sentenced to Die` `The Feeding of the Five Thousand`
...
[`sp_ubs`](sp_ubs.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|UBS5 part of speech|`verb` `subs` `art` `conj`
...
[`subjref`](subjref.md#readme)|[`Edge`](featuresbytype.md#Edge)|[`String`](featuresbydatatype.md#String)|subject referent|`Link`
...
[`subjrefspec`](subjrefspec.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|number of subject referent|`46003022002` `66001009002` `45001001001` `47010001004`
...
[`ubsprontype`](ubsprontype.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|types of pronouns|`prs` `dem` `rel` `irg`
...
[`variant`](variant.md#readme)|[`Node`](featuresbytype.md#Node)|[`Integer`](featuresbydatatype.md#Integer)|lexical lemma variant|`2` `1`
[`verbtype`](verbtype.md#readme)|[`Node`](featuresbytype.md#Node)|[`String`](featuresbydatatype.md#String)|No feature description|`NA` `Place`
[`verse`](verse.md#readme)|[`Node`](featuresbytype.md#Node)|[`Integer`](featuresbydatatype.md#Integer)|verse number|`1` `2` `3` `5`
