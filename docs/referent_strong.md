...
## Description
Strong's number of textual participant a word is referring to (excluding subject)
## Feature Values
...
Total frequency of feature: 14494. Note: table truncated.
